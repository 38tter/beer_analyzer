...
struct BeerRecord: Codable, Identifiable {
    ...
    init(analysisResult: BeerAnalysisResult, userId: String, timestamp: Date, imageUrl: String, hasDrunk: Bool = false, websiteUrl: String? = nil, memo: String? = nil, rating: Double? = nil) {
